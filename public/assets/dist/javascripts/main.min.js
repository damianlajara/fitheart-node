...
jQuery.isFunction(options)&&(options=options.call(elem,i,jQuery.extend({},curOffset))),null!=options.top&&(props.top=options.top-curOffset.top+curTop),null!=options.left&&(props.left=options.left-curOffset.left+curLeft),"using"in options?options.using.call(elem,props):curElem.css(props)}},jQuery.fn.extend({offset:function(options){if(arguments.length)return void 0===options?this:this.each(function(i){jQuery.offset.setOffset(this,options,i)});var docElem,win,elem=this[0],box={top:0,left:0},doc=elem&&elem.ownerDocument;if(doc)return docElem=doc.documentElement,jQuery.contains(docElem,elem)?(box=elem.getBoundingClientRect(),win=getWindow(doc),{top:box.top+win.pageYOffset-docElem.clientTop,left:box.left+win.pageXOffset-docElem.clientLeft}):box},position:function(){if(this[0]){var offsetParent,offset,elem=this[0],parentOffset={top:0,left:0};return"fixed"===jQuery.css(elem,"position")?offset=elem.getBoundingClientRect():(offsetParent=this.offsetParent(),offset=this.offset(),jQuery.nodeName(offsetParent[0],"html")||(parentOffset=offsetParent.offset()),parentOffset.top+=jQuery.css(offsetParent[0],"borderTopWidth",!0)-offsetParent.scrollTop(),parentOffset.left+=jQuery.css(offsetParent[0],"borderLeftWidth",!0)-offsetParent.scrollLeft()),{top:offset.top-parentOffset.top-jQuery.css(elem,"marginTop",!0),left:offset.left-parentOffset.left-jQuery.css(elem,"marginLeft",!0)}}},offsetParent:function(){return this.map(function(){for(var offsetParent=this.offsetParent;offsetParent&&"static"===jQuery.css(offsetParent,"position");)offsetParent=offsetParent.offsetParent;return offsetParent||documentElement})}}),jQuery.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(method,prop){var top="pageYOffset"===prop;jQuery.fn[method]=function(val){return access(this,function(elem,method,val){var win=getWindow(elem);return void 0===val?win?win[prop]:elem[method]:void(win?win.scrollTo(top?win.pageXOffset:val,top?val:win.pageYOffset):elem[method]=val)},method,val,arguments.length)}}),jQuery.each(["top","left"],function(i,prop){jQuery.cssHooks[prop]=addGetHookIf(support.pixelPosition,function(elem,computed){return computed?(computed=curCSS(elem,prop),rnumnonpx.test(computed)?jQuery(elem).position()[prop]+"px":computed):void 0})}),jQuery.each({Height:"height",Width:"width"},function(name,type){jQuery.each({padding:"inner"+name,content:type,"":"outer"+name},function(defaultExtra,funcName){jQuery.fn[funcName]=function(margin,value){var chainable=arguments.length&&(defaultExtra||"boolean"!=typeof margin),extra=defaultExtra||(margin===!0||value===!0?"margin":"border");return access(this,function(elem,type,value){var doc;return jQuery.isWindow(elem)?elem.document.documentElement["client"+name]:9===elem.nodeType?(doc=elem.documentElement,Math.max(elem.body["scroll"+name],doc["scroll"+name],elem.body["offset"+name],doc["offset"+name],doc["client"+name])):void 0===value?jQuery.css(elem,type,extra):jQuery.style(elem,type,value,extra)},type,chainable?margin:void 0,chainable,null)}})}),jQuery.fn.extend({bind:function(types,data,fn){return this.on(types,null,data,fn)},unbind:function(types,fn){return this.off(types,null,fn)},delegate:function(selector,types,data,fn){return this.on(types,selector,data,fn)},undelegate:function(selector,types,fn){return 1===arguments.length?this.off(selector,"**"):this.off(types,selector||"**",fn)},size:function(){return this.length}}),jQuery.fn.andSelf=jQuery.fn.addBack,"function"==typeof define&&define.amd&&define("jquery",[],function(){return jQuery});var _jQuery=window.jQuery,_$=window.$;return jQuery.noConflict=function(deep){return window.$===jQuery&&(window.$=_$),deep&&window.jQuery===jQuery&&(window.jQuery=_jQuery),jQuery},noGlobal||(window.jQuery=window.$=jQuery),jQuery})},{}],14:[function(require,module,exports){var angular=require("angular");require("angular-route"),require("jquery"),require("angular-material"),window.Chart=require("chart.js"),require("angular-chartjs"),require("./controllers/index"),require("./routes/index"),require("./services/index"),angular.module("fitHeart",["ngRoute","chartjs","ngMaterial","frontEndRoutes","MainCtrl","HomeCtrl","UserCtrl","UserService"])},{"./controllers/index":18,"./routes/index":20,"./services/index":22,angular:11,"angular-chartjs":5,"angular-material":7,"angular-route":9,"chart.js":12,jquery:13}],15:[function(require,module,exports){angular.module("HomeCtrl",[]).controller("HomeController",["$scope",function($scope){$scope.lineConfig={maintainAspectRatio:!0,responsive:!0},$scope.lineData={labels:["January","February","March","April","May","June","July","August","September","October","November","December"],datasets:[{label:"My First dataset",fillColor:"rgba(220,220,220,0.2)",strokeColor:"rgba(220,220,220,1)",pointColor:"rgba(220,220,220,1)",pointStrokeColor:"#fff",pointHighlightFill:"#fff",pointHighlightStroke:"rgba(220,220,220,1)",data:[65,59,80,81,56,55,40,23,43,65,76,87]},{label:"My Second dataset",fillColor:"rgba(151,187,205,0.2)",strokeColor:"rgba(151,187,205,1)",pointColor:"rgba(151,187,205,1)",pointStrokeColor:"#fff",pointHighlightFill:"#fff",pointHighlightStroke:"rgba(151,187,205,1)",data:[28,48,40,19,86,27,90,43,65,76,87,100]}]}}])},{}],16:[function(require,module,exports){angular.module("MainCtrl",[]).controller("MainController",["$scope","$mdSidenav",function($scope,$mdSidenav){$scope.openLeftMenu=function(){console.log("clicked on toggle button"),$mdSidenav("left").toggle()};var menu={social:[{link:"",title:"Dashboard",icon:"dashboard"},{link:"",title:"Friends",icon:"group"},{link:"",title:"Messages",icon:"message"}],health:[{link:"",title:"Fitness",icon:"fitness_center"},{link:"",title:"Nutrition",icon:"battery_charging_full"},{link:"",title:"Goals",icon:"timeline"},{link:"",title:"Meal Plan",icon:"assignment"},{link:"",title:"Mood",icon:"insert_emoticon"}],admin:[{link:"",title:"Trash",icon:"delete"},{link:"",title:"Settings",icon:"settings"}]};$scope.socialMenu=menu.social,$scope.healthMenu=menu.health,$scope.adminMenu=menu.admin}])},{}],17:[function(require,module,exports){angular.module("UserCtrl",[]).controller("UserController",["$scope","User",function($scope,User){User.get().success(function(users){$scope.users=users})}])},{}],18:[function(require,module,exports){require("./MainCtrl"),require("./HomeCtrl"),require("./UserCtrl")},{"./HomeCtrl":15,"./MainCtrl":16,"./UserCtrl":17}],19:[function(require,module,exports){angular.module("frontEndRoutes",[]).config(["$routeProvider","$locationProvider",function($routeProvider,$locationProvider){$routeProvider.when("/",{templateUrl:"views/home.html",controller:"HomeController"}).when("/users",{templateUrl:"views/user.html",controller:"UserController"}),$locationProvider.html5Mode(!0)}])},{}],20:[function(require,module,exports){require("./frontEndRoutes")},{"./frontEndRoutes":19}],21:[function(require,module,exports){angular.module("UserService",[]).factory("User",["$http",function($http){return{get:function(){return $http.get("/api/users").success(function(data){return data}).error(function(err){return err})},create:function(userData){return $http.post("/api/users",userData).success(function(data){return data}).error(function(err){return err})},put:function(id,newData){return $http.put("/api/users/"+id).success(function(data){return data}).error(function(err){return err})},"delete":function(id){return $http["delete"]("/api/users/"+id).success(function(data){return data}).error(function(err){return err})}}}])},{}],22:[function(require,module,exports){require("./UserService")},{"./UserService":21}]},{},[14]);
